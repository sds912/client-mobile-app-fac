...
Padding paddingDrownButton6({Size size , bool isLast = false}) {
  return Padding(
            ...
            child: DropdownButton(
              ...
              onChanged: (t) async {
                await getAllNewLocalite().then((liste) async {
                  await getSubdivisionLocalite(t, liste).then((value) {
                    bienvenuePageState.setState(() {
                      bienvenuePageState.niveauSixLocalite.subdivisions =
                          value;
                    });
                  });
                });
                bienvenuePageState.setState(() {
                  ...
                  bienvenuePageState.niveauSixLocalite.idParent = t.idParent;
                ...
                bienvenuePageState.setState(() {
                  resetStateStep7();
                  bienvenuePageState.niveauSept =
                      buildSousSection(bienvenuePageState.niveauSixLocalite);
                });
              },
              underline: Container(),
              icon: Icon(
